...
import edu.java.SecurityRestDeveloperApi.security.jwt.JwtConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String MODERATOR_ENDPOINTS = "/api/v1/moderator/**";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(ADMIN_ENDPOINTS).hasAnyRole("ADMIN")
                .antMatchers(MODERATOR_ENDPOINTS).hasAnyRole("ADMIN", "MODERATOR")
                .antMatchers(USER_ENDPOINTS).hasAnyRole("ADMIN", "MODERATOR", "USER")
